    ...
    <section class="">
        <div class="mention">
            <div class="no-warp">
                ...
                <p>
                    Merci de lire avec attention les différentes modalités d’utilisation du présent site avant d’y parcourir ses pages. En vous connectant sur ce site, vous acceptez sans réserves les présentes modalités. Aussi, conformément à l’article n°6 de la Loi n°2004-575 du 21 Juin 2004 pour la confiance dans l’économie numérique, le responsable du présent site internet <a href="<?=url("/"); ?>" >theindependentgamers.fr</a> est :
                </p>
                ...
                <ul class="mention-ul">
                        ...
                        <li>site web : <a href="<?=url("/"); ?>" >theindependentgamers.fr</a></li>
                ...
                <ul class="mention-ul">
                    ...
                    <li>site web : <a href="https://www.scaleway.com" target=_blank >www.scaleway.com</a></li>
                ...
                <p>
                    Ce site (<a href="<?=url("/"); ?>" >theindependentgamers.fr</a>) est proposé en différents langages web (HTML, HTML5, Javascript, CSS, etc…) pour un meilleur confort d’utilisation et un graphisme plus agréable, nous vous recommandons de recourir à des navigateurs modernes comme Internet explorer, Safari, Firefox, Google Chrome, etc…
                </p>
                ...
                <p>
                    Le site <a href="<?=url("/"); ?>" >theindependentgamers.fr</a> est peut-être amené à vous demander l’acceptation des cookies pour des besoins statistiques et d’affichage. Un cookie est une information déposée sur votre disque dur par le serveur du site que vous visitez. Il contient plusieurs données qui sont stockées sur votre ordinateur dans un simple fichier auquel un seriveur accède pour lire et enregistrer des informations. Certaines parties de ce site ne peuvent être fonctionnelle sans l’acceptation de cookies.
                </p>
                ...
                <p>
                    L’ensemble des activités de la société ainsi que ses informations sont présentés sur mon site <a href="<?=url("/"); ?>" >theindependentgamers.fr</a>.
                </p>

                <p>
                    Brandon SIMON-VERMOT s’efforce de fournir sur le site <a href="<?=url("/"); ?>" >theindependentgamers.fr</a> des informations aussi précises que possible. Les renseignements figurant sur le site <a href="<?=url("/"); ?>" >theindependentgamers.fr</a> ne sont pas exhaustifs et les photos non contractuelles. Ils sont donnés sous réserve de modifications ayant été apportées depuis leur mise en ligne. Par ailleurs, toutes les informations indiquées sur le site <a href="<?=url("/"); ?>" >theindependentgamers.fr</a> sont données à titre indicatif, et sont susceptibles de changer ou d’évoluer sans préavis.
                </p>
                ...
                <p>
                    Tout le contenu du présent site <a href="<?=url("/"); ?>" >theindependentgamers.fr</a>, incluant, de façon non limitative, les graphismes, images, textes, vidéos, animations, sons, logos, gifs et icônes ainsi que leur mise en forme sont la propriété exclusive de la société à l’exception des marques, logos ou contenus appartenant à d’autres sociétés partenaires ou auteurs.
                </p>
                ...
                <p>
                    Les présentes conditions du site <a href="<?=url("/"); ?>" >theindependentgamers.fr</a> sont régies par les lois françaises et toute contestation ou litiges qui pourraient naître de l’interprétation ou de l’exécution de celles-ci seront de la compétence exclusive des tribunaux dont dépend le siège social de la société. La langue de référence, pour le règlement de contentieux éventuels, est le français.
                </p>

                <h3>Données personnelles</h3>

                <p>
                    De manière générale, vous n’êtes pas tenu de nous communiquer vos données personnelles lorsque vous visitez notre site Internet <a href="<?=url("/"); ?>" >theindependentgamers.fr</a>.
                </p>
